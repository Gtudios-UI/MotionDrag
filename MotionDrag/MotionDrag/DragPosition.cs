...
public readonly record struct DragPosition(GlobalContainerRect ContainerPosition, Rect OriginalItemRect, Point MouseOffset, Point CumulativeTranslation) {
    ...
    public Point MousePositionToContainer => MouseOffset.Point() + CumulativeTranslation;
    ...
    public Point ItemPositionToScreen => ContainerPosition.PointToScreen(OriginalItemRect.Point() + CumulativeTranslation);
    public DragPosition ToNewContainer(GlobalContainerRect newContainer) => new(
        newContainer,
        ContainerPosition.ToNewContainer(newContainer, OriginalItemRect),
        ContainerPosition.ScaleToNewContainer(newContainer, MouseOffset),
        ContainerPosition.ToNewContainer(newContainer, CumulativeTranslation)
    );
}
